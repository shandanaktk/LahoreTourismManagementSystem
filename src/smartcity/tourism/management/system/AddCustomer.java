...
//                getContentPane().setBackground(new Color(190,90,40));
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("smartcity/tourism/management/system/icons/AddCustomer.png"));
		...
		contentPane.add(lblId);
                ...
                comboBox = new JComboBox(new String[] {"Passport", "CNIC Card", "Driving license"});
